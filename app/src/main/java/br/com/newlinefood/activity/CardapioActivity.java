    ...
    private void recuperarPedido() {
        ...
        pedidoRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                TextView textCarrinhoQuantidade = findViewById(R.id.textCarrinhoQuantidade);
                TextView textCarrinhoTotal = findViewById(R.id.textCarrinhoTotal);

                DecimalFormat df = new DecimalFormat("0.00");

                textCarrinhoQuantidade.setText("Quantidade: " + String.valueOf(quantidadeItensCarrinho));
